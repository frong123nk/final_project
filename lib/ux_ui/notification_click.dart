...
class _NotificationScreenState extends State<NotificationScreen> {
    ...
    return StreamBuilder<List<Medicine>>(
        ...
        builder: (context, snapshot) {
          ...
          for (int i = 0; i < snapshot.data.length; i++) {
            if (snapshot.data[i].id.toString() == widget.payload) {
              dataIndex = i;
            }
          }
          medicine = snapshot.data[dataIndex];
          return Scaffold(
  ...
  List<String> getDay() {
    List<String> day = [];
    for (int i = 0; i < medicine.selectDay.length; i++) {
      day.add(medicine.selectDay[i]);
    }
    return day;
  }
  ...
  List<String> getWeek() {
    List<String> week = [];
    for (int i = 0; i < medicine.selectWeekly.length; i++) {
      week.add(medicine.selectWeekly[i]);
    }
    return week;
  }
